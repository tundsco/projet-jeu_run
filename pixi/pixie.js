...
// load spine data
PIXI.Assets.load('./assets/').then(onAssetsLoaded);
...
function onAssetsLoaded(pixieAsset) {
    ...
    const background = PIXI.Sprite.from('./assets/');
    const background2 = PIXI.Sprite.from('./assets/');

    const foreground = PIXI.Sprite.from('./assets/');
    const foreground2 = PIXI.Sprite.from('./assets/');
